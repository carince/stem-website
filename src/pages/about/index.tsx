...
import { PageTransition, ScrollReveal, anim, RevealUpwards } from "../../components/animate";
...
export default function Home() {
    return (
        <PageTransition>
            <main
                className={`w-screen h-screen flex flex-col items-center justify-between p-5 pt-24 ${inter.className} overflow-scroll`}
            >
                <div className="text-lg font-light space-y-5">
                    <ScrollReveal>
                        <h1 className="font-semibold text-5xl">About the app!</h1>
                    </ScrollReveal>
                    <ScrollReveal>
                    <p>
